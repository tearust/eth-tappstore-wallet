export default {
  ...
  MachineNotExist: 'Machine ID is invalid, please contact TeaProject for more details.',


  // layer2
  'CX_214': 'You don\'t have access to make payment on this transaction.',
  'CX_217': 'Session expired, please login again.',
  'OP_104': 'You have insufficient funds to complete this action.',

  'not_login': 'Not login or login expired, please login again.',
