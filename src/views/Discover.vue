...
export default {
  ...
  created(){
    this.app_cid_map = {
      ...
      '0xc000000000000000000000000000000000000001': utils.get_env('gov_hkd_cid'),
      '0xc000000000000000000000000000000000000002': utils.get_env('gov_sgd_cid'),
      '0xc000000000000000000000000000000000000003': utils.get_env('gov_inr_cid'),
    };
  },
